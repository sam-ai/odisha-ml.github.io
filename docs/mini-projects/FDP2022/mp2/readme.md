...
Data: Use this dataset to train and evaluate the classifier: [https://www.kaggle.com/competitions/iiitd-abuse-detection-challenge/data.](https://www.kaggle.com/datasets/disisbig/hindi-movie-reviews-dataset)
